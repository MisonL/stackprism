...
export const FOCUS_CATEGORY = '重点'
export const RAW_PLACEHOLDER = '展开后生成原始线索。'
export const CACHE_REFRESH_DELAYS = [1200, 2600, 5000] as const

export const STATUS_HIDE_DELAY = 3000
